      ...
      <div className="sale-component">
        <article className="sale-left-section">
          ...
          <div className="sale-images">
            <img
              src={this.props.imgsources[0]}
              className="sale-main-image"
              alt={this.props.imgsources[0]}
            />
            <div className="sale-other-images">
              <img
                src={this.props.imgsources[1]}
                alt={this.props.imgsources[1]}
              />
              <img
                src={this.props.imgsources[2]}
                alt={this.props.imgsources[2]}
              />
              <img
                src={this.props.imgsources[3]}
                alt={this.props.imgsources[3]}
              />
            </div>
          </div>
          <h4>Description</h4>
        ...
        <div className="sale-mid-section" />
        <aside className="sale-right-section">
          <span className="sale-price">{this.props.price} $</span>
          <span className="sale-nego">
            {this.props.nego ? "négociable" : "fixe"}
          </span>
          <br />
          <span className="sale-wearandtear">
            Condition: {this.props.wear}/10
          </span>
          <br />
          ...
          <br />
          <div className="sale-tags-section">
            {this.props.tags.map((item, key) => (
              <span className="sale-tag" key={key}>
                {item}
              </span>
            ))}
          </div>
